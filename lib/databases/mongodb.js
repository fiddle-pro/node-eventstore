...
_.extend(Mongo.prototype, {
  ...
  streamEventsUntil: function (date, skip, limit) {
    var findStatement = { commitStamp: { '$lte': date } };
  ...
  getEventsUntil: function (date, skip, limit, callback) {
    this.streamEventsUntil(date, skip, limit).toArray(callback);
  },
